  ...
  return (
    <main className="mx-auto max-w-md px-5 py-10 sm:py-16">
      <div className="rounded-3xl border border-stone-200/80 bg-white/95 p-6 shadow-sm backdrop-blur sm:p-8 dark:border-stone-700 dark:bg-stone-900/85">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-stone-500 dark:text-stone-400">Welcome back</p>
        ...
        <form action={loginAction} className="mt-6 space-y-3" aria-label="Login form">
          ...
          <button className="min-h-11 w-full rounded-xl bg-stone-900 p-2.5 text-sm font-semibold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-stone-800 active:scale-[0.99] dark:bg-stone-100 dark:text-stone-900 dark:hover:bg-stone-200">Log in</button>
        </form>
